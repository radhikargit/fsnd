...
def create_venue_submission():
    ...
    try:
        ...
        st = request.form['seeking_talent']
        p = False
        if st == 'y':
            p = True
        v.seeking_talent = p
        v.description = request.form['seeking_description']
...
def create_show_submission():
    ...
    try:
        s = Show()
        s.venue_id = request.form['venue_id']
        s.artist_id = request.form['artist_id']
